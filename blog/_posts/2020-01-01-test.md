...
For style guidance (colors, fonts, buttons, etc.), see the [style guide](/style-guide/).
...
Inline charts use the `{% raw %}{% chart %}{% endraw %}` block tag with a [Chart.js configuration object](https://www.chartjs.org/docs/latest/configuration/):
...
{% chart %}
{
  ...
  "data": {
    ...
    "datasets": [{
      "label": "Widgets",
      "data": [12, 19, 3, 5],
      "backgroundColor": ["#903465", "#89ae00", "#787af2", "#e54c4c"]
    }]
  },
  "options": {
