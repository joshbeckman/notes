...
tags:
- index
serial_number: 2026.PAE.020
---
Weight Training activities from my [exercise journal](/exercise), pulled from [Strava](https://www.strava.com/athletes/75003252).

{% include ContributionGraph.html category="weight-training" %}

{% assign postsByMonth = 
site.categories['weight-training'] | group_by_exp:"post", "post.date | date: '%Y %B'" %}
