...
tags:
- index
serial_number: 2026.PAE.019
---
Walking activities from my [exercise journal](/exercise), pulled from [Strava](https://www.strava.com/athletes/75003252).

{% include ContributionGraph.html category="walking" %}

{% assign postsByMonth = 
site.categories['walking'] | group_by_exp:"post", "post.date | date: '%Y %B'" %}
