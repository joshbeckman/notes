...
---
Cycling activities from my [exercise journal](/exercise), pulled from [Strava](https://www.strava.com/athletes/75003252).

{% include ContributionGraph.html category="cycling" %}

{% assign postsByMonth = 
site.categories['cycling'] | group_by_exp:"post", "post.date | date: '%Y %B'" %}
