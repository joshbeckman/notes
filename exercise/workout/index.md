...
tags:
- index
serial_number: 2026.PAE.021
---
Workout activities from my [exercise journal](/exercise), pulled from [Strava](https://www.strava.com/athletes/75003252).

{% include ContributionGraph.html category="workout" %}

{% assign postsByMonth = 
site.categories['workout'] | group_by_exp:"post", "post.date | date: '%Y %B'" %}
