...
tags:
- index
serial_number: 2026.PAE.013
---
Hiking activities from my [exercise journal](/exercise), pulled from [Strava](https://www.strava.com/athletes/75003252).

{% include ContributionGraph.html category="hiking" %}

{% assign postsByMonth = 
site.categories['hiking'] | group_by_exp:"post", "post.date | date: '%Y %B'" %}
