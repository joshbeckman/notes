...
tags:
- index
serial_number: 2026.PAE.018
---
Tennis activities from my [exercise journal](/exercise), pulled from [Strava](https://www.strava.com/athletes/75003252).

{% include ContributionGraph.html category="tennis" %}

{% assign postsByMonth = 
site.categories['tennis'] | group_by_exp:"post", "post.date | date: '%Y %B'" %}
