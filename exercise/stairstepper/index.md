...
tags:
- index
serial_number: 2026.PAE.017
---
Stair Stepper activities from my [exercise journal](/exercise), pulled from [Strava](https://www.strava.com/athletes/75003252).

{% include ContributionGraph.html category="stairstepper" %}

{% assign postsByMonth = 
site.categories['stairstepper'] | group_by_exp:"post", "post.date | date: '%Y %B'" %}
