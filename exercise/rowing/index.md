...
tags:
- index
serial_number: 2026.PAE.015
---
Rowing activities from my [exercise journal](/exercise), pulled from [Strava](https://www.strava.com/athletes/75003252).

{% include ContributionGraph.html category="rowing" %}

{% assign postsByMonth = 
site.categories['rowing'] | group_by_exp:"post", "post.date | date: '%Y %B'" %}
