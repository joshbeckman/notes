...
tags:
- index
serial_number: 2026.PAE.022
---
Yoga activities from my [exercise journal](/exercise), pulled from [Strava](https://www.strava.com/athletes/75003252).

{% include ContributionGraph.html category="yoga" %}

{% assign postsByMonth = 
site.categories['yoga'] | group_by_exp:"post", "post.date | date: '%Y %B'" %}
