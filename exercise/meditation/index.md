...
tags:
- index
serial_number: 2026.PAE.014
---
Meditation activities from my [exercise journal](/exercise), pulled from [Strava](https://www.strava.com/athletes/75003252).

{% include ContributionGraph.html category="meditation" %}

{% assign postsByMonth = 
site.categories['meditation'] | group_by_exp:"post", "post.date | date: '%Y %B'" %}
