...
tags:
- index
serial_number: 2026.PAE.012
---
HIIT activities from my [exercise journal](/exercise), pulled from [Strava](https://www.strava.com/athletes/75003252).

{% include ContributionGraph.html category="highintensityintervaltraining" %}

{% assign postsByMonth = 
site.categories['highintensityintervaltraining'] | group_by_exp:"post", "post.date | date: '%Y %B'" %}
