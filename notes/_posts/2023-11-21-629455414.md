...
tags: building tools workspaces
...
Maybe the distinction is that a library serves discovery while a workshop serves execution, and conflating the two is exactly the kind of perfectionist trap Jack is warning against