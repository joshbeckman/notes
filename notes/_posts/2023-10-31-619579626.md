...
The slotted counter trades write contention for read complexity, which begs the question Marc Brooker raised in [Optimism vs Pessimism in Distributed Systems](https://www.joshbeckman.org/notes/612841017): what optimistic assumption about your workload are you embedding when you choose this pattern (that reads are rarer or cheaper than writes) and at what read-to-write ratio does that assumption flip and make the pattern self-defeating?