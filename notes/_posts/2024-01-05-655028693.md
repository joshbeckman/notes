...
tags: note-taking publishing writing
...
This duty isn't abstract. Simon Sarris' [Breadcrumbs](https://www.joshbeckman.org/notes/801368263) makes the same case through the same metaphor: leaving a trail is how you build community and pull others forward. And James Stanier's [Read Widely, Apply Selectively, Share Regardless](https://www.joshbeckman.org/notes/582169995) scales it up: real progress in any field comes from a *collective* of people marking their paths, not just lone experts, so even your "obvious" documentation is load-bearing for someone else.